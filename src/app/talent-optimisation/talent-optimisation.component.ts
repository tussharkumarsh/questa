...
@Component({
  selector: 'app-talent-optimisation',
  templateUrl: './talent-optimisation.component.html',
  styleUrls: ['./talent-optimisation.component.scss']
})
export class TalentOptimisationComponent implements OnInit {
